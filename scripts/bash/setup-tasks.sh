...
if [[ -z "$TASKS_TEMPLATE" ]] || [[ ! -f "$TASKS_TEMPLATE" ]]; then
    ...
    echo "Template 'tasks-template' was not found. Add a project override at .geass/templates/overrides/tasks-template.md, or check that the geass plugin's bundled templates/tasks-template.md is present." >&2
    exit 1
fi
